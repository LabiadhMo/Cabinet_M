...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/PrendreRDV'), array(0 => 'ROLE_USER'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/'), array(0 => 'ROLE_ADMIN'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/Cabinet/Administration'), array(0 => 'ROLE_DOCTOR', 1 => 'ROLE_ASSISTANT'), NULL);
